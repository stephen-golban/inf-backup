...
import Svg, { Path, Circle, SvgProps, Rect, Defs, LinearGradient, Stop } from 'react-native-svg';

const ConnectedWorldIcon: React.FC<SvgProps> = props => {
  return (
    <Svg width={605.25} height={761.48} viewBox="0 0 605.25 761.48" {...props}>
      <Defs>
        <LinearGradient id="a" x1={304.32} y1={452.8} x2={304.32} y2={148.23} gradientUnits="userSpaceOnUse">
      ...
      <Rect x={120.96} y={148.23} width={366.73} height={304.56} rx={44.36} ry={44.36} fill="url(#a)" />
      ...
      <Path
        ...
        fill="#e0e0e0"
      />
      <Path fill="none" stroke="#6c63ff" strokeLinecap="round" strokeMiterlimit={10} strokeWidth={2} d="M302.63 288.42L302.63 299.88" />
      <Path
        d="M307.43 293.44a10.19 10.19 0 11-9.42-.09"
        fill="none"
        stroke="#6c63ff"
        strokeLinecap="round"
        strokeMiterlimit={10}
