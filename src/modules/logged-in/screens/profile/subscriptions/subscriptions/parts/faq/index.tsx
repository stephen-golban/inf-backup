...
const Faq = () => {
  const list = translate('profile:subscriptions:index:faq:questions' as I18nKey, { returnObjects: true }) as unknown as {
    q: string;
    a: string;
  }[];
  ...
  return (
    <View>
      <Text variant="24-bold" t18n="profile:subscriptions:index:faq:title" color="blue" />
