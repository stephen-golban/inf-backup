...
import { Locale } from '@typings/app';

interface ICreditReportOrderModule {
  loading?: boolean;
  onSubmit(input: CreditReportOrderFormFields): void;
}

const CreditReportOrderModule: React.FC<ICreditReportOrderModule> = ({ onSubmit, loading }) => {
...
export { CreditReportOrderModule };
